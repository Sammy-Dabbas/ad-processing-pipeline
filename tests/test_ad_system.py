...
class LocalTester:
    ...
    def check_processed_data(self):
        ...
        if lines:
            ...
            try:
                ...
                print("⚠️  Could not parse sample event")
    ...
    def performance_summary(self, gen_rate, proc_rate):
        ...
        gen_status = "✅" if gen_rate >= target_gen else "⚠️"
        proc_status = "✅" if proc_rate >= target_proc else "⚠️"
